...
clear
echo '#-----------------------------------------#'
echo '#     Sweetly GTK Theme Install Script    #'
echo '#-----------------------------------------#'
...
function set {
echo
show_question '\tDo you want to set Sweetly as desktop theme? (Y)es, (N)o : ' 
echo
read INPUT
case $INPUT in
    [Yy]* ) settheme;;
...
function settheme {
echo "Setting Sweetly as desktop GTK theme..."
gsettings reset org.gnome.desktop.interface gtk-theme
gsettings reset org.gnome.desktop.wm.preferences theme
gsettings set org.gnome.desktop.interface gtk-theme "Sweetly"
gsettings set org.gnome.desktop.wm.preferences theme "Sweetly"
echo "Done."
setthemegnome
}
